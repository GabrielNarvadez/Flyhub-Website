...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Avedi - Creative & Digital Agency Multipurpose Template</title>
...
<body>
    ...
    <!-- Start Our Features
    ============================================= -->
    <div class="features-area bottom-shape-light default-padding bottom-less">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="item">
                            ...
                            <p>
                                Particular boisterous uncommonly are. Early wrong as so manor match. Him necessary shameless discovery consulted one but. 
                            </p>
                            <a href="#"><i class="arrow_right"></i> Learn More</a>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    <!-- Single Item -->
    ...
    ============================================= -->
    <div class="why-choose-us-area default-padding-bottom bg-cover text-light" style="background-image: url(assets/img/2440x1578.png);">
        <div class="container">
                ...
                <div class="row align-center">
                    ...
                    <div class="col-lg-5">
                        <div class="heading-side">
                            ...
                            <!-- Shape Fixed Rotation -->
                            <h5>What we do</h5>
                            <h2>Does more then ever platform to achieve goal stages.</h2>
                            <p>
                                Wooded ladies she basket season age her uneasy saw. Discourse unwilling am no described dejection. 
                            </p>
                            ...
                            <div class="row">
                                <div class="item-grid col-lg-6 col-md-6">
                                    ...
                                    <div class="single-item">
                                        <div class="item">
                                            <div class="icon">
                                                <i class="flaticon-files-and-folders"></i>
                                            </div>
                                            <div class="info">
                                                <h5><a href="#">Data Tracking</a></h5>
                                                <p>
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item">
                            ...
                            <div class="pricing-footer">
                                <a class="btn circle btn-dark border btn-sm" href="#">Buy This Plan</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item active">
                            ...
                            <ul>
                                ...
                                <li>6 Top 10 Ranking  <i class="fas fa-check-circle"></i></li>
                                <li>Web site Analysis  <i class="fas fa-times-circle"></i></li>
                                <li>Keyword Research  <i class="fas fa-check-circle"></i></li>
                                <li>Content Optimization  <i class="fas fa-check-circle"></i></li>
                            </ul>
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item">
                            ...
                            <ul>
                                ...
                                <li>8 Top 10 Ranking  <i class="fas fa-check-circle"></i></li>
                                <li>Web site Analysis  <i class="fas fa-times-circle"></i></li>
                                <li>Keyword Research  <i class="fas fa-check-circle"></i></li>
                                <li>Content Optimization  <i class="fas fa-check-circle"></i></li>
                            </ul>
