<?php require 'assets/global/header.php';
                    ...
                    <div class="container">
                        <div class="banner-items">
                            <div class="row align-center">
                                <div class="col-lg-6">
                                    <div class="content">
                                        <h2 class="wow fadeInDown" data-wow-duration="400ms">Our goal is to achieve success</h2>
                                        ...
                                        <a href="#" class="btn-animate wow  fadeInLeft" data-wow-duration="600ms">
                                            ...
                                            <span class="button-text">Our Portfolio</span>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="item">
                            <div class="thumb">
                                ...
                                <div class="overlay">
                                    <div class="content">
                                        <h4>
                                            <a href="#">Throwing sociable children to achiving point.</a>
                                        </h4>
                                    </div>
                                    <div class="footer-meta">
                                       <ul>
